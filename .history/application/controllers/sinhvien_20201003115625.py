    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            for ind in df.index:
                ...
                newuser = User(User.user_name = df['student_id'],User.email = df['email'],User.full_name = df['student_name'],User.extra_data = df, User.company_id=request.args.get("company_id") )
