define(function (require) {
    ...
    var template 			= require('text!app/view/norm_hydraulic/tpl/collection.html');
				...
				buttons: [
					{
						...
						command: function(){
							var self = this;
							var path = self.collectionName + '_hydraulic/model';
    	...
    	uiControl:{
    		fields: [
		     ...
		     onRowClick: function(event){
		    	if(event.rowId){
		        		var path = this.collectionName + '_hydraulic/model?id='+ event.rowId;
