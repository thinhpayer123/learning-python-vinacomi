/*!
 gonrinEditor WYSIWYG HTML Editor v1.4.5
 http://premiumsoftware.net/gonrinEditor
...
(function ($) {
    ...
    $.gonrinEditor = {
        ...
        // Define the defaults used for all new gonrinEditor instances
        defaultOptions: {
    ...
    // gonrinEditor - creates a new editor for each of the matched textareas
    $.fn.gonrinEditor = function (options) {
    ...
    MAIN_CLASS = "gonrinEditorMain",    // main containing div
    TOOLBAR_CLASS = "gonrinEditorToolbar", // toolbar div inside main div
    GROUP_CLASS = "gonrinEditorGroup",   // group divs inside the toolbar div
    BUTTON_CLASS = "gonrinEditorButton",  // button divs inside group div
    DISABLED_CLASS = "gonrinEditorDisabled",// disabled button divs
    DIVIDER_CLASS = "gonrinEditorDivider", // divider divs inside group div
    POPUP_CLASS = "gonrinEditorPopup",   // popup divs inside body
    LIST_CLASS = "gonrinEditorList",    // list popup divs inside body
    COLOR_CLASS = "gonrinEditorColor",   // color popup div inside body
    PROMPT_CLASS = "gonrinEditorPrompt",  // prompt popup divs inside body
    MSG_CLASS = "gonrinEditorMsg",     // message popup div inside body
    ...
    // gonrinEditor - creates a new editor for the passed in textarea element
    gonrinEditor = function (area, options) {

        var editor = this;

        // Get the defaults and override with options
        editor.options = options = $.extend({}, $.gonrinEditor.defaultOptions, options);
    ...
    var fn = gonrinEditor.prototype,

    // Expose the following private functions as methods on the gonrinEditor object.
    // The closure compiler will rename the private functions. However, the
    // exposed method names on the gonrinEditor object will remain fixed.
    methods = [
        ["clear", clear],
        ["disable", disable],
    ...
    // imagesPath - returns the path to the images folder
    function imagesPath() {
        var href = $("link[href*=gonrinEditor]").attr("href");
